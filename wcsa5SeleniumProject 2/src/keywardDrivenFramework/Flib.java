...
public class Flib {
	...
	public int readExcelData(String excelPath, String sheetName) throws EncryptedDocumentException, IOException
	{
		FileInputStream fis = new FileInputStream(excelPath);
		Workbook wb = WorkbookFactory.create(fis);
		Sheet sheet = wb.getSheet(sheetName);
	...
	public String writeExcelData(String propPath, String key) throws IOException
	{
